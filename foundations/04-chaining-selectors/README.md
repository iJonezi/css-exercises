...
- Did you properly chain class selectors for each rule? - Completed
- Does the `proportioned` image retain its original square proportions? - Completed
- Does the `distorted` image end up looking squished and, well, distorted? - Completed
