...
- Does each element have a unique class name? - Completed
- Did you use the grouping selector for styles that both elements share? - Completed
- Did you make separate rules for the styles unique to each element? - Completed
